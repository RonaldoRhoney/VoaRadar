...
Buscador de passagens aéreas com busca orçamento-primeiro: "tenho X reais, para onde posso viajar?" — você diz quanto quer gastar, de onde sai e quando, e o Voa Radar explora destinos compatíveis, com filtros e ordenação.

Produto RhoneyInc.

> Estado atual: v0.2.0 ("Explore") concluída (tag `v0.2.0`), sobre a fundação da v0.1.0. **Dados mock** em todas as versões até integração validada com um provedor real (`FlightProvider`/`MockFlightProvider`).
